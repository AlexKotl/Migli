...
<h2>Сумма заказа: <?= "<span id='orderSum' data-items-sum='{$tpl[items_sum]}'>".$tpl[items_sum]."</span>" ?> грн</h2>
	...
	<div class='orderText'>
		<p/>ДОСТАВКА: Самовывоз с ул. Петрозаводская 2а, офис 406 (м. Вокзальная) <b>по предварительной договоренности</b>
		<p/>Доставка по Украине за счет покупателя по тарифам выбранной вами компании (отдаем предпочтение Новой почте). 
		<p/>ПРИ ЗАКАЗЕ ОТ 500 ГРН. И ОПЛАТЕ НА КАРТУ ПРИВАТБАНКА ДОСТАВКА ПО УКРАИНЕ НОВОЙ ПОЧТОЙ БЕСПЛАТНО.
	</div>
	<table width=500>
